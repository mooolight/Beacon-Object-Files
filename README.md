...
| **BOF**                  | **Use**                                                                                                                                                         |
|--------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **[RTCore](byovd/rtcore/)**     | Capabilities not limited to elevating the target process' token similar to SYSTEM through modification of kernel memory with the help of the RTCore64.sys vulnerable driver.|
